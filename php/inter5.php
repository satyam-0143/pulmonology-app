...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST["pid"])) {
        ...
        $sql5 = mysqli_query($conn, "SELECT apr FROM patient_info where pid='$id' ");
        $sql6 = mysqli_query($conn, "SELECT aprfvc FROM patient_info where  pid ='$id' ");
        $sql7 = mysqli_query($conn, "SELECT aprfev1 FROM patient_info where pid='$id' ");
        $sql8 = mysqli_query($conn, "SELECT aprfef FROM patient_info where  pid ='$id' ");
